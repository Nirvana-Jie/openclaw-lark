...
import { STREAMING_ELEMENT_ID, buildCardContent, toCardKit2  } from '../../card/builder';
import { setCardStreamingMode, streamCardContent, updateCardKitCard } from '../../card/cardkit';
...
import { buildMarkdownCard, updateCardFeishu } from './send';
